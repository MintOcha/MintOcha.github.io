...
if(this.turn>0&&!this.usesUpkeep)this.updateTurnCounters();
this.turn=turnNum;
this.started=true;
...
addBatch=function addBatch(commands){for(var _i64=0;_i64<
commands.length;_i64++){var command=commands[_i64];
...
this.updateTurnCounters();for(var _i66=0,_this$sides6=

this.sides;_i66<_this$sides6.length;_i66++){var side=_this$sides6[_i66];
...
break;
default:for(var _i68=0,_this$sides8=
this.sides;_i68<_this$sides8.length;_i68++){var _side3=_this$sides8[_i68];_side3.active=[null];}
break;
}
...
_side8.clearPokemon();for(var _i70=0;_i70<
team.length;_i70++){var set=team[_i70];
...
if(set.ability)_pokemon3.rememberAbility(set.ability);for(var _i72=0,_set$moves2=
set.moves;_i72<_set$moves2.length;_i72++){var move=_set$moves2[_i72];
...
if(stack){for(var _i74=0,_stack$split2=
stack.split('\n');_i74<_stack$split2.length;_i74++){var line=_stack$split2[_i74];
if(/\brun\b/.test(line)){
break;
}
this.log(['error',line]);
